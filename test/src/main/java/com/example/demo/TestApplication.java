...
//    maskedReview = maskedReview.replaceAll(emailRegex, "$1****$3");
	...
	// 하지만 개발 환경과 운영환경은 그에 맞는 설정이 있다라는점을 언제나 알고 있어야함.
	...
	//  - 객체들은 상속 으로 관계를 가질수 있음.
	//  - 다른 객체를 참조할수 있음. (클래스를 변수 타입선언하고 변수 선언하듯이 사용)
	//  - 객체 그래프의 자유로운 탐색.
	...
	// 과거에는 이 차이점때문에 개발자들이 객체를 db에 저장하거나
	// db에서 데이터를 불러올때 변환하는 작업 자체가 개짜증....
	//  -> 객체와 관계의 임피던스 불일치.
	//   객체지향 프로그래밍과 관계형 DB간의 구조적, 개념적 차이를 설명할때 얘기하는 개념.
	...
	//       건축가(프로그램)가 그 코드를 해석해 DB와 소통하는것.
